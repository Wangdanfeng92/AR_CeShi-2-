...
namespace cn.sharesdk.unity3d 
{
	...
	public class QQ : DevInfo 
	{
		...
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.QQ;
        public string app_id = "1105342390";
        public string app_key = "yYaEN3JLdrhbFtDP";
		public string auth_type = "both";  //can pass "both","sso",or "web" 
		#endif
	}
	...
	{	
		...
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.WeChat;
        public string app_id = "wx2107254a2a458a73";
        public string app_secret = "eb64d34fc124ca6bfa106d119330fe7a";
		#endif
	}
