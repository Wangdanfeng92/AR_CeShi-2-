...
public class ShareSDKTest : MonoBehaviour
{
    ...
    public void ShowContents() 
    {
        ...
        content.SetText("this is a test string For QQ.");
    ...
    public void ShowContentsForWeChat()
    {
        ShareContent content = new ShareContent();
        content.SetText("this is a test string For WeChat.");
        content.SetImageUrl("https://f1.webshare.mob.com/code/demo/img/1.jpg");
        content.SetTitle("test title");
        content.SetTitleUrl("http://www.mob.com");
        content.SetSite("Mob-ShareSDK");
    ...
    public void ShowContentsForWeChatComment()
    {
        ShareContent content = new ShareContent();
        content.SetText("this is a test string For WeChatComment.");
        content.SetImageUrl("https://f1.webshare.mob.com/code/demo/img/1.jpg");
        content.SetTitle("test title");
        content.SetTitleUrl("http://www.mob.com");
        content.SetSite("Mob-ShareSDK");
    ...
    public void ShowContentsForSinaWeiBo()
    {
        ShareContent content = new ShareContent();
        content.SetText("this is a test string For SinaWeiBo.");
        content.SetImageUrl("https://f1.webshare.mob.com/code/demo/img/1.jpg");
        content.SetTitle("test title");
        content.SetTitleUrl("http://www.mob.com");
        content.SetSite("Mob-ShareSDK");
